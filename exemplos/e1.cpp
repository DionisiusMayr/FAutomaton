...
int main() {
	...
	/* Funcao de transicao */
	transicao[make_pair("q1", '0')] = "q1";
	transicao[make_pair("q1", '1')] = "q2";
	transicao[make_pair("q2", '0')] = "q3";
	transicao[make_pair("q2", '1')] = "q2";
	transicao[make_pair("q3", '0')] = "q1";
	transicao[make_pair("q3", '1')] = "q4";
	transicao[make_pair("q4", '0')] = "q5";
	transicao[make_pair("q4", '1')] = "q2";
	transicao[make_pair("q5", '0')] = "q5";
	transicao[make_pair("q5", '1')] = "q5";
